...
if([string]$prov.performance_patch_version -ne 'mobile-engine-v2'){$failures.Add("performance_patch_version=$($prov.performance_patch_version)")}
...
Write-Host "SWF_PERFORMANCE_PATCH_VALIDATE=PASS source_sha256=$canonicalSwfSha patched_sha256=$seedHash version=mobile-engine-v2"
