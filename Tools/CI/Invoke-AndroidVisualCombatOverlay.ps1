...
'@
  ...
  $versionReplacement='$patchVersion=''mobile-engine-v3.23-visual-combat-rootfix'''
  ...
  Write-Host "VISUAL_COMBAT_PATCH_VERSION=PASS semantic=true previous=$previousPatchVersion current=$versionReplacement"
