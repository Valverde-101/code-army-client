...
$impl=Join-Path $PSScriptRoot 'Invoke-AndroidEvidenceRootFixOverlayV50.ps1'
...
if(@($errors).Count -gt 0){
  ...
  throw 'ANDROID_EVIDENCE_ROOTFIX_V14_COMPAT=FAIL v50_parser_invalid'
}
Write-Host 'ANDROID_EVIDENCE_ROOTFIX_V14_DELEGATE=PASS implementation=v46 adapters=v47+v48+v49+v50 parser=true'
...
try {
  ...
  Write-Host "ANDROID_EVIDENCE_ROOTFIX_V14_COMPAT=PASS delegated=v46 adapters=v47,v48,v49,v50 mode=$Mode sha=$ExpectedSha v4_boundary_fixed=true"
}
finally {
