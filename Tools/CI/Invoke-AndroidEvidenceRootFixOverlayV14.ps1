...
$impl=Join-Path $PSScriptRoot 'Invoke-AndroidEvidenceRootFixOverlayV47.ps1'
...
if(@($errors).Count -gt 0){
  ...
  throw 'ANDROID_EVIDENCE_ROOTFIX_V14_COMPAT=FAIL v47_parser_invalid'
}
Write-Host 'ANDROID_EVIDENCE_ROOTFIX_V14_DELEGATE=PASS implementation=v46 adapter=v47 parser=true'
...
try {
  ...
  Write-Host "ANDROID_EVIDENCE_ROOTFIX_V14_COMPAT=PASS delegated=v46 adapter=v47 mode=$Mode sha=$ExpectedSha v4_boundary_fixed=true"
}
finally {
