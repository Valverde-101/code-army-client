...
try {
  ...
  Write-Host "ANDROID_EVIDENCE_ROOTFIX_V14_COMPAT=PASS delegated=v56 predecessor=v55 mode=$effectiveMode sha=$ExpectedSha v4_boundary_fixed=true final_composition=true legacy_adapters_bypassed=true"
}
finally {
