...
'@.TrimEnd() 'runtime_test_save_sources'
  ...
  $test=Replace-LiteralOne $test "Require-Contains `$offline 'savedata[`"saveversion`"] = 9;' 'offline_save_schema_current_v9'" "Require-Contains `$offline 'CURRENT_SAVE_VERSION:int = 9' 'offline_save_schema_current_v9'" 'runtime_test_offline_save_version_v9'
  $test=Replace-LiteralOne $test "Require-Contains `$offline 'savedata[`"saveversion`"] = 9;' 'daily_reward_save_migration_version_bumped'" "Require-Contains `$offline 'savedata[`"saveversion`"] = CURRENT_SAVE_VERSION;' 'daily_reward_save_migration_version_bumped'" 'runtime_test_daily_reward_saveversion_current'
  $saveAssertions=@'
