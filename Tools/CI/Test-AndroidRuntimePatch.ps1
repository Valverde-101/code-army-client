...
Require-Contains $pvpEnemy '_loc6_ = "pvp_good_sniper_" + _loc5_.substr("good_sniper_".length);' 'pvp_enemy_sniper_uses_real_opfor_family'
Require-NotContains $pvpEnemy '_loc6_ = "pvp_premium_infantry_" + _loc5_.substr("good_sniper_".length);' 'pvp_enemy_sniper_wrong_infantry_fallback_removed'
...
Require-NotContains $gameHud 'this.mIngameHUDClip_BOTTOM.y = Math.min(0,param2 - 750);' 'mobile_hud_old_negative_parent_offset_removed'
...
Require-Contains $dcButton 'this.freezeStaticTimelines(this.mButton);' 'static_button_states_freeze_nested_icons'
...
Require-Contains $pvpHud 'this.mGame.mPvPMatch.passPlayerTurn();' 'pvp_cancel_button_passes_turn'
...
Require-Contains $match 'Utils.DiagEvent("PVP_PASS_TURN"' 'pvp_pass_turn_is_instrumented'
Require-Contains $hfe 'flash.utils.getTimer' 'hfe_harvest_uses_wall_clock'
Require-Contains $hfe 'expectedFrame:int' 'hfe_harvest_catches_up_after_dropped_frames'
Require-Contains $hfe 'HFE_HARVEST_ANIMATION' 'hfe_harvest_timing_is_instrumented'
Require-Contains $swfPatch "Class='game.gameElements.HFEObject'" 'swf_patch_includes_hfe_wall_clock_fix'
...
Write-Host 'REGRESSION=PASS suite=android-runtime-v3.18-pvp-ui-hfe-frame-spikes'
