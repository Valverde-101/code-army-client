...
Require-Contains $pvpBooster '_loc3_.text == "99"' 'pvp_booster_default_99_is_replaced'
...
Require-Contains $pvpEnemy 'mode=opfor_move_dark' 'pvp_enemy_movement_preserves_visual_identity'
