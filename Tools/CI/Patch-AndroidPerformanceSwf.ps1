...
$patchSpecs=@(
  ...
  [ordered]@{Class='game.isometric.pathfinding.PathfindCriteria';Source='src\game\isometric\pathfinding\PathfindCriteria.as';Log='ffdec-feature-side-aware-pathfinding.log'},
  [ordered]@{Class='game.gameElements.EnemyInstallationObject';Source='src\game\gameElements\EnemyInstallationObject.as';Log='ffdec-feature-installation-wrecking-mines.log'},
  [ordered]@{Class='game.gameElements.PlayerInstallationObject';Source='src\game\gameElements\PlayerInstallationObject.as';Log='ffdec-feature-friendly-turret-combat.log'},
  [ordered]@{Class='game.gameElements.DecorationObject';Source='src\game\gameElements\DecorationObject.as';Log='ffdec-feature-friendly-mines.log'},
